; ==================================================================
; KaushOS -- An Operating System kernel written in Assembly
; by Janani. This OS is inspired by MikeOS. Great thanks
...
welcome_string      db 'welcome to KaushOS that made by Janani', 0
prompt_string       db 'KaushOS:>', 0
